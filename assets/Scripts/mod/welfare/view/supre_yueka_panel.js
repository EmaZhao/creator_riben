...
var Supre_yuekaPanel = cc.Class({
    ...
    initPanel: function () {
        ...
        this.Text_3_nd = this.main_container.getChildByName("Text_3");
        this.Text_3_nd.active = false;
        ...
        //     this.card_data.month_card1_return.val[0][1], PathTool.getItemRes(item_config.icon))
        ...
        //     Utils.getNodeCompByPath("main_container/Text_3", this.root_wnd, cc.Label).string = Utils.TI18N("(贵族玩家可以获得额外奖励加成)");
    },
